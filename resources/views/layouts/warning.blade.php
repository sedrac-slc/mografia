...
@section('content')
<nav class="navbar navbar-expand-lg navbar-danger bg-warning mb-5">
    <div class="container-fluid">
      <a class="navbar-brand text-white" href="#">mografia\aviso</a>
    </div>
</nav>
<section class="container mt-3">
    @isset($message,$descricao,$redirect)
    <div class="m-auto w-50 p-5 border rounded bg-warning text-monospace">
        ...
        <div class="bg-white p-3 rounded text-center mt-3">
          ...
          <div class="text-warning">[ {{$descricao}} ]</div>
        </div>
        <div class="mt-4">
            <a href="{{route('painel.page',$redirect)}}" class="text-decoration-none">
                <span class="bg-white p-2 text-warning rounded-circle">
                    <i class="fa-solid fa-angles-left ml-2"></i>
                </span>
                <span class="text-white ml-4">volta</span>
            </a>
        </div>
    </div>
    @endisset
